import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { l as parseURL$1, m as encodePath$1, n as decodePath, o as hasProtocol, q as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch, v as createHooks, h as createError$1, x as defu, y as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CWfTKyXC.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DLEPogOp.mjs')
  },
  {
    name: "rules",
    path: "/rules",
    component: () => import('./rules-LkYAiTrb.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-CbSL7a3H.mjs')
  },
  {
    name: "chapters-jabodetabek",
    path: "/chapters/jabodetabek",
    component: () => import('./jabodetabek-B6H3y3Ff.mjs')
  },
  {
    name: "community-management",
    path: "/community-management",
    component: () => import('./community-management-BzhD3kvO.mjs')
  }
];
...
const layouts = {
  custom: vueExports.defineAsyncComponent(() => import('./custom-CBq3PRy7.mjs').then((m) => m.default || m)),
  "partials-nav-header": vueExports.defineAsyncComponent(() => import('./NavHeader-DfmO14ax.mjs').then((m) => m.default || m)),
  "partials-the-footer": vueExports.defineAsyncComponent(() => import('./TheFooter-B7aEpvzH.mjs').then((m) => m.default || m))
};
...
const __nuxt_component_0 = vueExports.defineComponent({
  ...
  setup(props, context) {
    ...
    const layout2 = vueExports.computed(() => {
      let layout22 = vueExports.unref(props.name) ?? route?.meta.layout ?? routeRulesMatcher(route?.path).appLayout ?? "default";
      if (layout22 && !(layout22 in layouts)) {
        if (props.fallback) {
          layout22 = vueExports.unref(props.fallback);
        }
      }
      return layout22;
    });
          ...
          default: () => vueExports.h(
            LayoutProvider,
            {
              ...
              isRenderingNewLayout: (name) => {
                return name !== previouslyRenderedLayout && name === layout2.value;
              },
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_NuxtLayout, vueExports.mergeProps({ name: layout }, _attrs), {
      ...
      ssrRenderSuspense_1(_push, {
        default: () => {
          if (vueExports.unref(abortRender)) {
            ...
            _push(ssrRenderComponent_1(vueExports.unref(ErrorComponent), { error: vueExports.unref(error) }, null, _parent));
