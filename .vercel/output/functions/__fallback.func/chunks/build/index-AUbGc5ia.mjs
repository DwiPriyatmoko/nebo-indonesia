import { createVNode, resolveDynamicComponent, ref, mergeProps, unref, withCtx, openBlock, createBlock, Fragment, renderList, useSSRContext } from 'vue';
      ...
      if (banners.length > 0) {
        ...
        _push(ssrRenderComponent(_component_Swiper, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<!--[-->`);
              ssrRenderList(banners, (item, index) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="absolute inset-0 overflow-hidden"${_scopeId2}><img class="hero-slide-img h-full w-full object-cover scale-105"${ssrRenderAttr("src", item.media_path)}${ssrRenderAttr("alt", item.title || "NEBO Community")}${_scopeId2}></div><div class="absolute inset-0 bg-gradient-to-r from-brand-ink/95 via-brand-ink/60 to-transparent"${_scopeId2}></div><div class="absolute inset-0 bg-gradient-to-t from-brand-ink/80 via-transparent to-brand-ink/30"${_scopeId2}></div>`);
                    } else {
                      return [
              ...
              return [
                (openBlock(), createBlock(Fragment, null, renderList(banners, (item, index) => {
...
//# sourceMappingURL=index-AUbGc5ia.mjs.map
