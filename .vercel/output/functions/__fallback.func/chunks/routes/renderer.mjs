import { a as withLeadingSlash, j as joinRelativeURL, b as useRuntimeConfig, c as getResponseStatusText, d as getResponseStatus, e as defineRenderHandler, f as getQuery, h as createError, i as getRouteRules, k as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"id"}};
