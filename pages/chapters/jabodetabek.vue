			...
			<div class="relative isolate">
				...
				<div class="overflow-hidden">
					...
					>
						<div class="mb-8">
							<NuxtImg
								src="/assets/images/chapters/jabodetabek.png"
								alt=""
								class="max-w-[400px] mx-auto rounded-xl bg-gray-900/5 object-cover shadow-lg"
							/>
						</div>
						<div
						...
						>
							<div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
								...
								>
									Selamat Datang di NEBO!
								</h1>
								<p
									class="mt-6 text-md leading-8 text-gray-600 sm:max-w-md lg:max-w-none"
								>
									Senang sekali bisa menyambut kamu sebagai bagian dari keluarga
									besar NEBO. Di sini, kita tidak hanya berbagi pengalaman,
									ilmu, dan cerita tentang motor, tapi juga menjalin
									persaudaraan yang erat di setiap perjalanan.
									<br />
									Mari bersama-sama menikmati setiap kilometer perjalanan,
									memperkuat solidaritas, dan menciptakan kenangan yang tak
									terlupakan. Jika ada yang perlu ditanyakan atau dibagikan,
									jangan ragu untuk menghubungi teman-teman NEBO lainnya.
								</p>
